    ...
    def create_initial_state(
        ...
        **kwargs,
        ...
        state = {
            ...
            "_original_message_count": len(all_messages),  # Track original count for filtering
        }

        return state
    
    @staticmethod
    def save_conversation_history(state: Dict[str, Any], filtered_messages: List[Any]) -> None:
        """
